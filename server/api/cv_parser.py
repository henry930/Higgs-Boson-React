...
class CVParser:
    ...
    def parse_cv(self, file_path: str) -> Dict:
        ...
        try:
            ...
            parsed_info['extracted_text'] = text[:2000]  # First 2000 chars for preview
    ...
    def _extract_experience_years(self, text: str) -> str:
        ...
        for pattern in experience_patterns:
            ...
            if matches:
                years = matches[0] if isinstance(matches[0], str) else matches[0][0]
...
def scan_and_parse_cv_directory(directory_path: str = None) -> List[Dict]:
    ...
    if directory_path is None:
        directory_path = os.path.join(settings.MEDIA_ROOT, 'applications', 'cvs')
