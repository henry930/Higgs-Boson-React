...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-&)7^c+1)@#j&5icv(ti#7vh#co-z%7ypxfzqjhudi_!78$0d!w')
...
DEFAULT_FROM_EMAIL = os.getenv('EMAIL_HOST_USER', 'noreply@higgsbosonconsultancy.com')
