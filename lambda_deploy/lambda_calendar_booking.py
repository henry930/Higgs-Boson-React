"""
AWS Lambda function for Google Calendar booking system
Handles both availability checking and appointment booking
"""
import json
import os
...
class GoogleCalendarLambda:
    ...
    def _init_service_account(self):
        ...
        try:
            ...
            # Service account configuration - you'll need to store this securely in AWS Secrets Manager
